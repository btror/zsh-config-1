function theme_precmd {
  ...
  PR_FILLBAR=""
  PR_PWDLEN=""
  PR_EMOJI_1=`random_emoji favorites`
  PR_EMOJI_2=`random_emoji favorites2`
...
${PR_EMOJI_2} ${PR_CYAN}%(!.%SROOT%s.%n)${PR_GREY} ${PR_EMOJI_1}\
...
${PR_HBAR}\
>${PR_NO_COLOUR} '
# replaced ${PR_YELLOW}%D{%H:%M:%S}\ with ${PR_YELLOW}%D{%I:%M%P}\
